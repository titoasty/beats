...
let initialize = function() {
	...
	var beats = new BEATS.Interface(context, audio, {
	...
	beats.add(new BEATS.Key(1.0, 2.0, 0.8, 0.9, {
		...
		callback() { return console.log('Kicked'); }
	}
	)
	);
	...
	beats.add(new BEATS.Phase(55.000, { 'hit-hat' : { active : true }}));
